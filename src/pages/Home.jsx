    ...
    return (
      <>
        ...
        <div className="container3">
          <div className="bl2">
            <img src="https://hotelmt.com.br/wp-content/uploads/2018/01/159827-conheca-x-destinos-incriveis-para-fazer-trilhas-no-brasil.jpg" className="imh" alt="Trilhas no Brasil"></img>
          </div>
          <div className="bl1">
